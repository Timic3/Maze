...
void main() {   
    ...
    float speed = speed2;
    speed = -.004 * cos(u_time2*0.02 + 3.1415926/4.0);          
	//speed = 0.0;	
	...
	from.x += transverseSpeed*(6.0)*cos(0.3*u_time) + 0.01*u_time;
	from.y += transverseSpeed*(6.0)*sin(0.2*u_time) +0.01*u_time;
	
	dir.x -= 0.4*(transverseSpeed*(7.0)*cos(0.3*u_time) + 0.01*u_time);
	dir.y += 0.2*(transverseSpeed*(7.0)*sin(0.2*u_time) +0.01*u_time);
